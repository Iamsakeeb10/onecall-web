          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="bg-white border border-pearl-200 rounded-2xl overflow-hidden flex flex-col sm:flex-row h-full shadow-card hover:border-steel/40 hover:shadow-card-hover transition-all duration-300 group hover:-translate-y-1">
                  ...
                  <div className="flex flex-col justify-between p-4 sm:p-5 w-full sm:w-3/5">
                    {/* Icon Badge */}
                    <div className="w-8 h-8 rounded-lg bg-steel-muted flex items-center justify-center mb-2">
                      <IconComponent className="w-4 h-4 text-steel" aria-hidden="true" />
                    </div>

                    {/* Title */}
                    <h3 className="font-display text-base sm:text-lg font-bold text-navy mb-2 line-clamp-2">
                      {service.title}
                    </h3>
                    ...
                    <ul className="space-y-1.5 mb-3 flex-grow">
                      {service.features.slice(0, 2).map((feature, idx) => (
                        <li key={idx} className="flex items-start gap-1.5">
                          <CheckCircle className="w-3.5 h-3.5 text-steel mt-0.5 flex-shrink-0" aria-hidden="true" />
                    ...
                    >
                      Learn More
                      <ArrowRight className="w-3.5 h-3.5 text-steel transition-transform duration-300 group-hover/link:translate-x-1" aria-hidden="true" />
                    </Link>
                  </div>
                </div>
              </motion.div>
